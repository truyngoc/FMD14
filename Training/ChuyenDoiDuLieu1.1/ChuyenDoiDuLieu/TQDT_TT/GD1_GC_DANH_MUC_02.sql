use SLXNK
go
/*Script: thong ke danh sach San pham theo Hop dong Gia cong
...
select a1.So_HD, a1.DVGC, a1.Ngay_Ky, b1.P_Code, b1.Ten_SP, b1.Ma_DVT
from dhdgc a1 inner join dspgc b1
