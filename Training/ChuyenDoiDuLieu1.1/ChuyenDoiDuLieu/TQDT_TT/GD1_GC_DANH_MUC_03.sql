use SLXNK
go
/*Script: thong ke danh sach Nguyen lieu theo Hop dong Gia cong
...
select a1.So_HD, a1.DVGC, a1.Ngay_Ky, b1.P_Code, b1.Ten_NPL, b1.Ma_DVT
from dhdgc a1 inner join dnplhd b1
