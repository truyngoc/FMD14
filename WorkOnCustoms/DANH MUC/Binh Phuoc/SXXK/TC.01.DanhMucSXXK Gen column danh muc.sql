...
from DDINHMUC dm join SSP s on dm.MA_SP = s.MA_SP and dm.MA_DV=s.MA_DV and rtrim(dm.MA_HQ)=rtrim(s.MA_HQ)
...
from DDINHMUC dm join SNPL l on dm.MA_NPL=l.MA_NPL and dm.MA_DV=l.MA_DV and rtrim(dm.MA_HQ)=rtrim(l.MA_HQ)
