...
sqlcmd -U %usr% -P %pwd% -S %srv% -d %dbs%  -i "SXXK.Linkserver ECustoms_Online to SXXK.sql" -v lnksrv_name=%lnksrv_name% lnksrv_datasource1=%lnksrv_datasource% usr_src=%usr_src% pwd_src=%pwd_src%  -b >> "%IDCucHQ%_%IDChiCuc%_Report_log.txt"
