...
Set		h.CDDL_TK_ID	= t.CDDL_TK_ID
		,h.CDDL_MA_HQ	= SUBSTRING(h.ma_hq,2,2) + SUBSTRING(h.ma_hq,1,1) + SUBSTRING(h.ma_hq,4,10)
...
From	DHangMDTH h join DToKhaiMD t on t.SoTK = h.SoTK and t.Ma_LH=h.Ma_LH and t.Ma_HQ=h.Ma_HQ and t.NamDK=h.NamDK
...
Set		h.CDDL_TK_ID	= t.CDDL_TK_ID
		...
		,h.CDDL_MA_DVT		= dbo.Doi_Ma_DVT(MA_DVT)
From	DHangMDDC h join DToKhaiMD t on t.SoTK = h.SoTK and t.Ma_LH=h.Ma_LH and t.Ma_HQ=h.Ma_HQ and t.NamDK=h.NamDK
...
From	DHangMDDC h join DHangMDDC_CT c on h.SOTK=c.SOTK and h.MA_LH=c.MA_LH and h.MA_HQ=c.MA_HQ and h.NAMDK=c.NAMDK and h.MA_PHU=c.MA_PHU and h.LAN_DC=c.LAN_DC
...
From	DNPLNHAP h join DToKhaiMD d on h.MA_HQ = d.MA_HQ and h.Ma_LH = d.Ma_LH and h.SoTK = d.SoTK and h.NamDK = d.NamDK
...
set		CDDL_DGIA_TT	= DGIA_TT
		,CDDL_TS_XNK	= TS_XNK
From	DNPLNHAP h join DHangMDTH d on h.MA_HQ = d.MA_HQ and h.Ma_LH = d.Ma_LH and h.SoTK = d.SoTK and h.NamDK = d.NamDK and h.MA_NPL = d.MA_NPL_SP
...
set		CDDL_DGIA_TT	= DGIA_TT
		,CDDL_TS_XNK	= TS_XNK
From	DNPLNHAP h join DHangMDDC d on h.MA_HQ = d.MA_HQ and h.Ma_LH = d.Ma_LH and h.SoTK = d.SoTK and h.NamDK = d.NamDK and h.MA_NPL = d.MA_NPL_SP
...
if exists (select MaHQ
			...
			Where MaHQ in ('01AB02','01AB04','01AB05','01DD01','01DD03','01DD05','01PM','01PM01','01TE','01TE02','01TE03','02AB','02AB04','02IK02','02IK03','02IK04','02XF','02XF01','02XF02','11BB','11BB01','11BG','11BG01','15BB01','15BB02','15BE01','15BE02','15BE03','15BE04','18BA01','18BA02','18BA03','18BB','18BB01','20BB01','20BB02','27BB','27BB01','30CF','30CF01','31CD01','31CD02','31CD03','40BB01','40BB02','40PD01','40PD02','43IH','43IH02','43NK','43NK01','43NK02','45NF02','45NF03','47CD','47CD01','47CD02','47CI','47CI01','48BF03','48BF04','51CC','51CC01','61BA','61BA01','61PA','61PA02','01TE01','01PO')
			)
