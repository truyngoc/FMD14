...
set		CDDL_DGIA_TT	= DGIA_TT
		,CDDL_TS_XNK	= TS_XNK
From	DNPLNHAP h join DHangMDTH d on rtrim(h.MA_HQ) = rtrim(d.MA_HQ) and h.Ma_LH = d.Ma_LH and h.SoTK = d.SoTK and h.NamDK = d.NamDK and h.MA_NPL = d.MA_NPL_SP
...
set		CDDL_DGIA_TT	= DGIA_TT
		,CDDL_TS_XNK	= TS_XNK
From	DNPLNHAP h join DHangMDDC d on rtrim(h.MA_HQ) = rtrim(d.MA_HQ) and h.Ma_LH = d.Ma_LH and h.SoTK = d.SoTK and h.NamDK = d.NamDK and h.MA_NPL = d.MA_NPL_SP
...
Update h
Set		h.CDDL_VT_ID = n.VT_ID
From	DHangMDTH h join DSX_SP_NPL n on h.CDDL_Ma_HQ=rtrim(n.Ma_HQ) and h.MA_NPL_SP=n.Ma_Vat_Tu and h.CDDL_Ma_Don_Vi=n.MA_DV and h.CDDL_Loai_Hang=n.Loai


Update h
Set		h.CDDL_VT_ID = n.VT_ID
From	DHangMDDC h join DSX_SP_NPL n on h.CDDL_Ma_HQ=rtrim(n.Ma_HQ) and h.MA_NPL_SP=n.Ma_Vat_Tu and h.CDDL_Ma_Don_Vi=n.MA_DV and h.CDDL_Loai_Hang=n.Loai

update	h
set		CDDL_VT_ID 	= d.VT_ID
From	DNPLNHAP h join DSX_SP_NPL d on h.CDDL_MA_HQ = rtrim(d.MA_HQ) and h.MA_DV=d.MA_DV and h.MA_NPL = d.MA_VAT_TU and d.LOAI = 1 --NPL
