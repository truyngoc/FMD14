...
:: thao tac tren server 01
sqlcmd -U %usr01% -P %pwd01% -S %srv01% -d %dbs01%  -i "Test_TC.05.eCustoms import To khai SXXK.sql" -v lnksrv_name=%lnksrv_name% sxxk_dbname_src=%sxxk_dbname_src% -b >> "%IDCucHQ%_%IDChiCuc%_Server01_log.txt"
