...
sqlcmd -U %usr% -P %pwd% -S %srv% -d %dbs%  -i "TC.01.SXXK. DanhMuc Gen column danh muc.sql" -v IDCucHQ=%IDCucHQ% IDChiCuc=%IDChiCuc% -b >> "%IDCucHQ%_%IDChiCuc%_Gen_column_log.txt"
::==========================================================
