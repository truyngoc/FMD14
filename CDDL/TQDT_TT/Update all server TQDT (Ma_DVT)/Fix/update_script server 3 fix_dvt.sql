...
from DCX_CT_TOKHAI_HANG h join $(lnksrv_name).$(slxnk_dbname_src).dbo.ecsCX_CT_TOKHAI_HANG s 
		...
		and s.CDDL_MA_HQ in ('01PL','01PO','01PR','02CX','02DS','02F1','02F2','03CE','03EE','18BC','43K1','43K2','43K3','47D1','47D2','47D3')
...
from DGC_DINH_MUC d join $(lnksrv_name).$(slxnk_dbname_src).dbo.ddmuc g 
  ...
  and g.CDDL_MA_HQ_HD in ('01PL','01PO','01PR','02CX','02DS','02F1','02F2','03CE','03EE','18BC','43K1','43K2','43K3','47D1','47D2','47D3')
