...
-- where t.Ma_Cuc_HQ = '43' 
		-- and (t.TK_ID >= 10000000000000 and t.TK_ID < 20000000000000) 
		-- and t.Ma_LH like '_GC%'
		-- and SUBSTRING(cast(t.TK_ID as varchar(50)),4,2) % 2 = 0
-- GO
...
-- where  t.Ma_Cuc_HQ = '43' 
		-- and (h.TK_ID >= 10000000000000 and h.TK_ID < 20000000000000) 
