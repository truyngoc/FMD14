...
sqlcmd -U %usr01% -P %pwd01% -S %srv01% -d %dbs01%  -i "update_script.sql"  -b >> "Log.txt"

::==========================================================

echo --- 2.Execution on Server 02 --- >> "Log.txt"

sqlcmd -U %usr02% -P %pwd02% -S %srv02% -d %dbs02%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================

echo --- 3.Execution on Server 03 --- >> "Log.txt"

sqlcmd -U %usr03% -P %pwd03% -S %srv03% -d %dbs03%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================

echo --- 4.Execution on Server 04 --- >> "Log.txt"

sqlcmd -U %usr04% -P %pwd04% -S %srv04% -d %dbs04%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================

echo --- 5.Execution on Server 05 --- >> "Log.txt"

sqlcmd -U %usr05% -P %pwd05% -S %srv05% -d %dbs05%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================

echo --- 6.Execution on Server 06 --- >> "Log.txt"

sqlcmd -U %usr06% -P %pwd06% -S %srv06% -d %dbs06%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================
...
sqlcmd -U %usr08% -P %pwd08% -S %srv08% -d %dbs08%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================

echo --- 9.Execution on Server 09 ---  >> "Log.txt"

sqlcmd -U %usr09% -P %pwd09% -S %srv09% -d %dbs09%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================
echo --- 10.Execution on Server 10 ---  >> "Log.txt"

sqlcmd -U %usr10% -P %pwd10% -S %srv10% -d %dbs10%  -i "update_script.sql"  -b >> "Log.txt"
::==========================================================
