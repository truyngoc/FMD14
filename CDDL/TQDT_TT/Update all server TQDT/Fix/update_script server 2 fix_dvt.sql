...
from DCX_CT_TOKHAI_HANG h join $(lnksrv_name).$(slxnk_dbname_src).dbo.ecsCX_CT_TOKHAI_HANG s 
		...
		and s.CDDL_MA_HQ in ('01B1','01B3','01PJ','01TE','02B2','02IK01','02K2','02K3','03CD','18A3','18ID','20B1','20B2','27NJ','27PE','32BD','34NG','43NG','45F1','45F2','48CG','51C1')
...
from DGC_DINH_MUC d join $(lnksrv_name).$(slxnk_dbname_src).dbo.ddmuc g 
  ...
  and g.CDDL_MA_HQ_HD in ('01B1','01B3','01PJ','01TE','02B2','02IK01','02K2','02K3','03CD','18A3','18ID','20B1','20B2','27NJ','27PE','32BD','34NG','43NG','45F1','45F2','48CG','51C1')
