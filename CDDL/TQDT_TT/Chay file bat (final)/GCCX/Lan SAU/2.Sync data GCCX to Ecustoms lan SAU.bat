...
::==========================================================
set HD_ID_max="điền giá trị"
set NPL_ID_max="điền giá trị"
set SP_ID_max="điền giá trị"
set TB_ID_max="điền giá trị"
set HM_ID_max="điền giá trị"
set DM_ID_max="điền giá trị"
set LOAISP_ID_max="điền giá trị"
set CX_VAO_ID_max="điền giá trị"
set CX_RA_ID_max="điền giá trị"
set CX_DM_ID_max="điền giá trị"
set CX_CTTK_ID_max="điền giá trị"
set CX_CTHang_ID_max="điền giá trị"
::==========================================================

echo Start time: %DATE% %TIME%

REM -v HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max%
...
sqlcmd -U %usr_online% -P %pwd_online% -S %srv_online% -d %dbs_online%  -i "TC.02.eCustoms Report GC CX TRUOC chuyen doi- Phai dien ID Cuc và CC.sql" -v IDCucHQ=%IDCucHQ% IDChiCuc=%IDChiCuc% -b >> "%IDCucHQ%_%IDChiCuc%_Report_log.txt"
...
:: thao tac tren server 01
sqlcmd -U %usr01% -P %pwd01% -S %srv01% -d %dbs01%  -i "TC.03.eCustoms Server 1 import du lieu lan SAU.sql" -v lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server01_log.txt"
...
sqlcmd -U %usr02% -P %pwd02% -S %srv02% -d %dbs02%  -i "TC.03.eCustoms Server 2 import du lieu lan SAU.sql" -v lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server02_log.txt"
::==========================================================
...
sqlcmd -U %usr03% -P %pwd03% -S %srv03% -d %dbs03%  -i "TC.03.eCustoms Server 3 import du lieu lan SAU.sql" -v  lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server03_log.txt"
::==========================================================
...
sqlcmd -U %usr04% -P %pwd04% -S %srv04% -d %dbs04%  -i "TC.03.eCustoms Server 4 import du lieu lan SAU.sql" -v  lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server04_log.txt"
::==========================================================
...
sqlcmd -U %usr05% -P %pwd05% -S %srv05% -d %dbs05%  -i "TC.03.eCustoms Server 5 import du lieu lan SAU.sql" -v  lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server05_log.txt"
::==========================================================
...
sqlcmd -U %usr06% -P %pwd06% -S %srv06% -d %dbs06%  -i "TC.03.eCustoms Server 6 import du lieu lan SAU.sql" -v  lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server06_log.txt"
::==========================================================
...
sqlcmd -U %usr07% -P %pwd07% -S %srv07% -d %dbs07%  -i "TC.03.eCustoms Server 7 import du lieu lan SAU.sql" -v  lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server07_log.txt"
::==========================================================
...
sqlcmd -U %usr08% -P %pwd08% -S %srv08% -d %dbs08%  -i "TC.03.eCustoms Server 8 import du lieu lan SAU.sql" -v  lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server08_log.txt"
::==========================================================
...
sqlcmd -U %usr09% -P %pwd09% -S %srv09% -d %dbs09%  -i "TC.03.eCustoms Server 9 import du lieu lan SAU.sql" -v  lnksrv_name=%lnksrv_name% slxnk_dbname_src=%slxnk_dbname_src% HD_ID_max=%HD_ID_max% NPL_ID_max=%NPL_ID_max% SP_ID_max=%SP_ID_max% TB_ID_max=%TB_ID_max% HM_ID_max=%HM_ID_max% DM_ID_max=%DM_ID_max% LOAISP_ID_max=%LOAISP_ID_max% CX_VAO_ID_max=%CX_VAO_ID_max% CX_RA_ID_max=%CX_RA_ID_max% CX_DM_ID_max=%CX_DM_ID_max% CX_CTTK_ID_max=%CX_CTTK_ID_max% CX_CTHang_ID_max=%CX_CTHang_ID_max% -b >> "%IDCucHQ%_%IDChiCuc%_Server09_log.txt"
::==========================================================

:: thao tac tren server chua ECUSTOMS_ONLINE
echo --- 1.4.Report data after sync ---
sqlcmd -U %usr_online% -P %pwd_online% -S %srv_online% -d %dbs_online%  -i "TC.04.eCustoms Report GC CX SAU chuyen doi- Phai dien ID Cuc và CC.sql" -v IDCucHQ=%IDCucHQ% IDChiCuc=%IDChiCuc% -b >> "%IDCucHQ%_%IDChiCuc%_Report_log.txt"
